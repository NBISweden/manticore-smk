...
rule popoolation_filter_pileup_by_gtf:
    ...
    output:
        pileup = temp("{results}/pool/analysis/{analysis}/{filternum}_{filtername}_{filtertype}/{sample}.{region}.{target}.pileup{gz}")
    input:
    ...
    log: "logs/{results}/pool/analysis/{analysis}/{filternum}_{filtername}_{filtertype}/{sample}.{region}.{target}.pileup{gz}.log"
